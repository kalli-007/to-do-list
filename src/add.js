        ...
        <div className=" p-5 flex items-center justify-center gap-2">
            ...
            <form onSubmit={(e) => {
              ...
              <input type="text" placeholder="Add your todo" value={inputValue} onChange={(e) => setInputValue(e.target.value)}
               className="p-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-violet-500 transition duration-300 ease-in-out w-full max-w-md mt-4" />
